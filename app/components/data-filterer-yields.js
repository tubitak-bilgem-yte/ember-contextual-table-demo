...
export default Ember.Component.extend({
  data: [
    ...
    {option: 'onfilterfieldupdated', type: 'closure-action', description: 'A closure-action that expected to be triggered ' +
    'whenever a filter for a field name is changed. It expects following parameters in order:<ul><li><b>fieldName</b> : ' +
